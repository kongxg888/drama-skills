...
正式人物身份母版默认遵循[默认人物身份四视图母版](character-identity-master-default.md)：一张无缝横向
画布自然排列四个视角——左侧正面全身身体视图、中间背面全身身体视图（两者均从锁骨以下裁切，
不入画头部、脸部、下巴、耳朵、头发和颈部），右上正面头部近景，右下右 45 度头部近景。背景
为中性摄影棚，光线柔和均匀，画面无文字、Logo、水印、边框、分隔线和拼贴缝。

这套版式只服务 `character-identity-master`。服装 Look 板、状态板和镜头状态图仍按用途选择视图；
模板不覆盖角色已经确认的身份锚点，也不替角色补造缺失事实。
...
1. **身份母版板**：默认使用四视图无缝画布，清楚固定同一人物的身体比例、背面轮廓与面部身份；四个视角保持同一时刻、同一套 Look。
2. **普通身份板**：若创作者明确只要临时参考图，可按用途做中性全身或三分之二身；它不能冒充正式 `character-identity-master`。
3. **面部识别板**：头肩为主，均匀光，发际与轮廓完整；适合妆面/身份锚点，不承担服装全貌。
4. **服装 Look 板**：全身正面与必要背面/局部，突出层次、穿法和鞋；面部仍保持身份，不能换成无脸 mannequin 除非创作者明确只做服装。
5. **状态板**：同一 Look 的有因果差异，如雨后湿袖、包扎后的左腕；只展示已接受状态，不把“前后对比”默认塞进一个画面。
